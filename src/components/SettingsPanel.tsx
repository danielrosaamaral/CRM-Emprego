    ...
    <div className="space-y-8 max-w-7xl mx-auto py-2 text-xs">
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <h2 className="font-serif text-2xl font-normal text-neutral-100 mt-0.5">
        ...
        <button
          ...
          onClick={handleSave}
          disabled={isSaving}
          className="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-md text-xs font-medium tracking-wide uppercase transition-all cursor-pointer shadow-xs disabled:opacity-50"
        >
      ...
      {importStatus && (
        <div className="bg-emerald-950/60 border border-emerald-800/80 text-emerald-300 px-4 py-3 rounded-md flex items-center gap-2">
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-6 space-y-4">
        <h3 className="font-serif text-base font-medium text-neutral-100 flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-neutral-800 border border-neutral-700 rounded-md focus:outline-none focus:border-blue-500 font-medium text-neutral-100 placeholder:text-neutral-500"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 bg-neutral-800 border border-neutral-700 rounded-md focus:outline-none focus:border-blue-500 text-neutral-100"
            >
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-6 space-y-5">
        <div className="flex items-center justify-between">
          <div>
            ...
            <h3 className="font-serif text-base font-medium text-neutral-100 mt-0.5 flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {(
            ...
            return (
              <div
                key={engine.id}
                className="border border-neutral-800 rounded-md p-4 bg-neutral-800/40 space-y-3 flex flex-col justify-between"
              >
                <div className="space-y-3">
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      <h4 className="font-medium text-neutral-100">{engine.name}</h4>
                  ...
                  <div className="space-y-1.5 pt-2 border-t border-neutral-800">
                    ...
                    <input
                      ...
                      className="w-full px-2.5 py-1.5 bg-neutral-800 border border-neutral-700 rounded text-[11px] text-neutral-100 focus:outline-none focus:border-blue-500 font-mono placeholder:font-sans placeholder:text-neutral-500"
                    />
                    ...
                    <div className="flex items-center justify-end gap-2 pt-1">
                      <button
                        ...
                        className="px-3 py-1.5 bg-neutral-800 border border-neutral-700 hover:bg-neutral-700 text-neutral-300 rounded text-[11px] font-medium transition-colors cursor-pointer disabled:opacity-50"
                      >
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 bg-neutral-700 hover:bg-neutral-600 text-white rounded text-[11px] font-medium transition-colors cursor-pointer disabled:opacity-50"
                      >
        ...
        <div className="pt-2 border-t border-neutral-800">
          <h4 className="font-medium text-neutral-200 mb-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
            {(
              ...
              return (
                <div key={t.id} className="p-2.5 rounded bg-neutral-800/50 border border-neutral-800 text-[11px] space-y-1">
                  <span className="font-semibold text-neutral-300">{t.label}</span>
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-6 space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
          {/* Export Group */}
          <div className="border border-neutral-800 rounded p-4 bg-neutral-800/40 space-y-3">
            <h4 className="font-medium text-neutral-200">Exportar Dados (CSV)</h4>
            <div className="flex flex-wrap gap-2">
              <button
                type="button"
                onClick={() => onExportCsv('ofertas')}
                className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-neutral-800 border border-neutral-700 hover:bg-neutral-700 rounded text-neutral-300 font-medium transition-colors cursor-pointer"
              >
          ...
          <div className="border border-neutral-800 rounded p-4 bg-neutral-800/40 space-y-3">
            ...
            <div className="flex flex-wrap gap-2">
              <label className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-blue-600 hover:bg-blue-500 text-white rounded font-medium transition-colors cursor-pointer">
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-6 space-y-3">
        ...
        <p className="text-neutral-400 text-xs leading-relaxed">
          A aplicação está estruturada de forma 100% modular, sem chaves secretas codificadas no repositório. Podes exportar para o GitHub ou clonar livremente. A base de dados em <code className="bg-neutral-800 text-neutral-300 border border-neutral-700 px-1 py-0.5 rounded font-mono text-[11px]">data/db.json</code> mantém todos os registos intactos em cada atualização e a configuração de chaves fica segura em <code className="bg-neutral-800 text-neutral-300 border border-neutral-700 px-1 py-0.5 rounded font-mono text-[11px]">data/config.json</code>.
        </p>
      </div>
    </div>
  );
