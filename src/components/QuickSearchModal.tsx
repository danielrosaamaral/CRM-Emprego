...
export const QuickSearchModal: React.FC<QuickSearchModalProps> = ({ query, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
      <div className="bg-neutral-900 rounded-lg max-w-lg w-full border border-neutral-800 shadow-2xl overflow-hidden text-xs">
        ...
        <div className="p-5 space-y-3">
          ...
          <div className="p-3 bg-neutral-800 rounded-md border border-neutral-700 font-mono text-[11px] text-neutral-100 break-all select-all">
            {query}
          </div>
        </div>
        ...
        <div className="px-5 py-3 border-t border-neutral-800 bg-neutral-900 flex items-center justify-end gap-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded bg-blue-600 hover:bg-blue-500 text-white font-medium transition-colors cursor-pointer shadow-xs"
          >
